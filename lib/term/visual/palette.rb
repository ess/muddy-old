...
module Term
	class Visual
		...
		# \0(*identifier*). Example: "This is not colored. \0(color)This is."
		#
		...
		#
		#     vt.current_window.print("\0(line number)1\0(default): " +
		#         "\0(variable)a\0(default) \0(operator)=\0(default) " +
		#         "2 \0(operator)+\0(default) 2")
		#
		# === All at once
		#
		#     vt.setcolors(
